    ...
    <div className="bg-[#111] text-gray-100 min-h-screen font-sans">
      <div className="max-w-6xl mx-auto p-8 pt-20 pb-20">
        ...
        <div className="text-center mb-16 border-b border-gray-800 pb-10">
          <h1 className="text-5xl font-extrabold tracking-tight text-white mb-4">Shipping Policy</h1>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800 hover:border-[#00bcd4] transition-all shadow-xl">
            ...
            <h3 className="text-2xl font-semibold text-white mb-3">Order Processing</h3>
          ...
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800 hover:border-[#00bcd4] transition-all shadow-xl">
            ...
            <h3 className="text-2xl font-semibold text-white mb-3">Delivery Timeline</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800 hover:border-[#00bcd4] transition-all shadow-xl">
            ...
            <h3 className="text-2xl font-semibold text-white mb-3">Flat Shipping Rates</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="bg-[#1a1a1a] p-8 rounded-2xl border border-gray-800 hover:border-[#00bcd4] transition-all shadow-xl">
            ...
            <h3 className="text-2xl font-semibold text-white mb-3">Live Order Tracking</h3>
            <p className="text-gray-300 leading-relaxed">
